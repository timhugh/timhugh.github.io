...
const socialLinks: SocialLink[] = [
  {
    ...
    icon: <GitHub className={socialIconClassName} aria-label="GitHub Icon" />,
  },
  {
    label: "LinkedIn Profile",
    href: "//linkedin.com/in/timheuett",
    icon: (
      <Linkedin className={socialIconClassName} aria-label="LinkedIn Icon" />
    ),
  },
  {
    ...
    icon: (
      <Instagram className={socialIconClassName} aria-label="Instagram Icon" />
    ),
  },
  {
    label: "Email",
